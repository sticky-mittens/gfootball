...
import argparse
import os
from scripts import policies_baseline as policies
from scripts import utils_baseline as utils
import argparse
import time
import random
...
for level_num in [1]: # 2, 3
    ...
    for OT_name in ep_map[level_num].keys():
        ...
        current_policy = policies.Hierarchical_Policies(level_num, OT_name, folder_name = f'saved_models_baseline_{args.type}_{args.gamma}_{args.learn_freq}_{args.lr}_{args.mem_size}_{args.n_layers}_{args.n_hidden_units}', use_demos = False, gamma = args.gamma, learn_freq = args.learn_freq, critic_lr = args.lr, mem_size = args.mem_size, n_layers = args.n_layers, n_hidden_units = args.n_hidden_units)
