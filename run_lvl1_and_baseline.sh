# lvl 1
# # 2, 3
# nohup python3 -u learning_with_option_templates.py --n_layers 2 --n_hidden_units 3 > output_easy_lvl1_2_3.txt &
# CUDA_VISIBLE_DEVICES=1 nohup python3 -u learning_with_option_templates.py --type medium --n_layers 2 --n_hidden_units 3 > output_medium_lvl1_2_3.txt &
# CUDA_VISIBLE_DEVICES=1 nohup python3 -u learning_with_option_templates.py --type hard --n_layers 2 --n_hidden_units 3 > output_hard_lvl1_2_3.txt &
